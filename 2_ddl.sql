...
CREATE TABLE IF NOT EXISTS dwh.customer_report_datamart (
    ...
    customer_money_pay NUMERIC(15,2), -- сумма, которую потратил заказчик
    ...
    median_time_order_completed BIGINT, -- медианное время в днях от момента создания заказа до его завершения за месяц
    top_product_category VARCHAR NOT NULL, -- самая популярная категория товаров у этого заказчика за месяц
    top_craftsman_id_customer VARCHAR NOT NULL, -- идентификатор самого популярного мастера ручной работы у заказчика
